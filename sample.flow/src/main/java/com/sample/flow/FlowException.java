 ...
 */
public class FlowException extends UnifiedException {
    /**
     * @param level          异常级别
     ...
     * @see ExceptionLevel
     */
    public FlowException(ExceptionLevel level, String errorCode, String errorMessage, String businessModule, Map<String, Object> context, Throwable cause) {
